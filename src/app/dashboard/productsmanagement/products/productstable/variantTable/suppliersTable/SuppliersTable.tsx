// src/SelectComponents/products/VariantsTable.tsx
    ...
    return (
        <Box margin={1}>
            ...
            <Table size="small" aria-label="variants">
                <TableHead>
                    <TableRow>
                        <TableCell>Supplier ID</TableCell> {/* Display the `variant_id` or `upc` if available */}
                ...
                <TableBody>
                    ...
                    {/*    <SupplierRow key={variant.variant_id} variant={variant}    />*/}
                    {/*))}*/}
                </TableBody>
            </Table>
        </Box>
